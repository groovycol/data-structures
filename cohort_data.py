def unique_houses(filename):
   ...
   #houses = set()
    ...
    for line in data_filename:
        ...
        set_list.append(working_line[2])
    houses = set(set_list)    
    return houses
...
def sort_by_cohort(filename):
    ...
    for line in data_filename:
        ...
        line = line.rstrip()
        #split the line on the pipe into a list
        working_line = line.split('|')
        
        if working_line[4] == "Spring 2015":
            name = working_line[0] + " " + working_line[1]
            spring_15.append(name)
        elif working_line[4] == "Winter 2015":
            name = working_line[0] + " " + working_line[1]
            winter_15.append(name)
        elif working_line[4] == "Summer 2015":
            name = working_line[0] + " " + working_line[1]
            summer_15.append(name)
        elif working_line[4] == "TA":
            name = working_line[0] + " " + working_line[1]
            tas.append(name)
        else:
            continue
